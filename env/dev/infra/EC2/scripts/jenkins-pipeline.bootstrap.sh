...
safe_run "Installing requests" "pip install --user checkov && pip install --user requests"
# Install virtualenv
safe_run "Install virtualenv" "python3 -m pip install --user virtualenv" false  # Not critical
...
safe_run "Install Checkov" "source /opt/security-tools-env/bin/activate && pip install requests checkov && deactivate" false
